...
SAML.prototype.initialize = function (options) {
  ...
  options.logger.log(DEBUG, 'Initialized options');
...
SAML.prototype.validatePostResponse = function (container, callback) {
  ...
  self.options.logger.log(DEBUG, 'Validating post response XML', xml);
  ...
  .fail(function(err) {
    self.options.logger.error('Error validating post response', err);
    callback(err);
  })
  .done();
};
